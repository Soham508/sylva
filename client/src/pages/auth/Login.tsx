                ...
                <div className="w-1/2 mt-28 flex flex-col items-center rounded-md gap-y-20 p-8">
                    ...
                    <div className="flex flex-col gap-y-8 w-full items-center border-b-[1px] border-black pb-10">
                        ...
                        <div className="flex w-full items-center flex-row gap-x-2 p-1 border-b-2 border-black ">
                            ...
                            <input type="password" placeholder="Enter your password" className="w-full p-4 rounded-lg text-xl hover:bg-slate-200/90 font-serif bg-slate-100 text-black border-0 focus:border-0 placeholder:text-black focus:outline-none focus:ring-0 placeholder-black" />
                        </div>
                        <span className="self-start cursor-pointer border-b-[1px] border-slate-100 hover:border-black -mt-4">Forgot passwrod?</span>
                        <button className="relative mt-10 h-12 w-32 active:bg-black/80  hover:bg-black/90 flex cursor-pointer items-center justify-center  text-white bg-black  font-semibold rounded-lg overflow-hidden">
                            Submit
                        </button>
                    </div>
